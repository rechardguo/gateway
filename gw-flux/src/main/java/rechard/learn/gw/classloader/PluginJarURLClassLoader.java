 ...
 * @author Rechard
 **/
public class PluginJarURLClassLoader extends URLClassLoader {

    private Object lock=new Object();
    private JarURLConnection cachedJarFile = null;

    public PluginJarURLClassLoader() {
        super(new URL[] {}, PluginJarURLClassLoader.class.getClassLoader());
    }
    ...
    public void hotswap(String oldJarFile, String newJarFile, String backupJar,
                        PluginClassLoader myClassLoader, String jarName) {
        synchronized (lock){
            //先关闭旧的jar
            unloadJarFile();
            //替换掉jar
